...
public class DesignatorComma extends DesignatorList {

    private DesignatorList DesignatorList;
    private OptionalDesignator OptionalDesignator;

    public DesignatorComma (DesignatorList DesignatorList, OptionalDesignator OptionalDesignator) {
