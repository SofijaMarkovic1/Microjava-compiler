...
public class DesignatorWithoutScopeResolutionAndIndexing extends Designator {

    private ArrayName ArrayName;
    private Expr Expr;

    public DesignatorWithoutScopeResolutionAndIndexing (ArrayName ArrayName, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorWithoutScopeResolutionAndIndexing(\n");
