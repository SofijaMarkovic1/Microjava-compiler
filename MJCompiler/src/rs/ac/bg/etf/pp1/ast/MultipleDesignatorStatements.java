...
public class MultipleDesignatorStatements extends DesignatorStatementList {

    private DesignatorStatementList DesignatorStatementList;
    private DesignatorStatement DesignatorStatement;

    public MultipleDesignatorStatements (DesignatorStatementList DesignatorStatementList, DesignatorStatement DesignatorStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleDesignatorStatements(\n");
