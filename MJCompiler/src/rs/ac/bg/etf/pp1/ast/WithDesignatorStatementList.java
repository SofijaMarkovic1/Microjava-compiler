...
public class WithDesignatorStatementList extends OptionalDesignatorStatementList {

    private DesignatorStatementList DesignatorStatementList;

    public WithDesignatorStatementList (DesignatorStatementList DesignatorStatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("WithDesignatorStatementList(\n");
